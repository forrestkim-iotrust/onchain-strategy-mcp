...
This project is indexed by GitNexus as **onchain-strategy-mcp** (3612 symbols, 9207 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
