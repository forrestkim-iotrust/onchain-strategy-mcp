...
| EXE-07 | Phase 6 | Complete (06-VERIFICATION 4/4 truths: LocalSignerHandle::from_env signs at boundary) |
| EXE-08 | Phase 6 | Complete (06-VERIFICATION: Alloy provider broadcast via send_transaction) |
| EXE-09 | Phase 6 | Complete (06-VERIFICATION: receipt wait + persisted confirmed/failed status) |
...
| STJ-06 | Phase 6 | Complete (06-VERIFICATION: tx_hash, receipt_status, gas_used, error_kind/detail persisted) |
| STJ-07 | Phase 6 | Complete (06-VERIFICATION: execution_get + execution://{run_id} share build_execution_report) |
| VER-01 | Phase 7 | Complete (07-VERIFICATION: erc20-approve.js exercised by verification_examples 3 passed) |
| VER-02 | Phase 7 | Complete (07-VERIFICATION: generic-counter-call.js exercised by verification_examples) |
| VER-03 | Phase 7 | Complete (07-VERIFICATION: verification_safety + workspace 512 passed) |
| VER-04 | Phase 7 | Complete (07-VERIFICATION: simulation-failure case + Phase 5 stdio grid) |
| VER-05 | Phase 7 | Complete (07-VERIFICATION: sandbox_host_globals + sandbox_limits in workspace) |
