...
| 1-02-03 | 02 | 2 | MCP-02 | — | Read-only tools (`strategy_list`, `policy_get`, `execution_get`, `strategy_get`) return placeholder shapes | unit/integration | `cargo test -p executor-mcp readonly_tools_return_placeholder` | ❌ W0 | ⬜ pending |
